...
public class MavenViolationsResultAction extends ViolationsResultAction
  ...
  public MavenViolationsResultAction(
    ...
    super(
        owner,
        healthDescriptor,
        new ViolationsResult(owner, defaultEncoding, new ParserResult(), false, false));
  ...
  @Override
  public void update(
      final Map<MavenModule, List<MavenBuild>> moduleBuilds, final MavenBuild newBuild) {
    // not used anymore
  }
}
