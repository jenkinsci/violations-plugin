...
public class ViolationsProjectAction extends AbstractProjectAction<ResultAction<ViolationsResult>> {
  ...
  public ViolationsProjectAction(
      final AbstractProject<?, ?> project,
      final Class<? extends ResultAction<ViolationsResult>> type) {
    super(
        project,
        type,
        Messages._Violations_ProjectAction_Name(),
        Messages._Violations_Trend_Name(),
        ViolationsDescriptor.PLUGIN_ID,
        ViolationsDescriptor.ICON_URL,
        ViolationsDescriptor.RESULT_URL);
  }
}
