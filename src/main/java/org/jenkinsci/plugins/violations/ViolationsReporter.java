...
public class ViolationsReporter extends HealthAwareReporter<ViolationsResult> {
  ...
  @Override
  protected MavenAggregatedReport createMavenAggregatedReport(
      final MavenBuild build, final ViolationsResult result) {
  ...
  @Override
  public ParserResult perform(
      final MavenBuildProxy build,
      final MavenProject pom,
      final MojoInfo mojo,
      final PluginLogger logger)
      throws InterruptedException, IOException {
    FilesParser violationsCollector =
        new FilesParser(
            PLUGIN_NAME,
