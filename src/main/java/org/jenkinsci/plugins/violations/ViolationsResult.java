...
public class ViolationsResult extends BuildResult {
  ...
  protected ViolationsResult(
    ...
    this(
        build,
        new BuildHistory(build, actionType, usePreviousBuildAsReference, useStableBuildAsReference),
        result,
        defaultEncoding,
        true);
  }
  ...
  protected String createDeltaMessage() {
    return createDefaultDeltaMessage(
        ViolationsDescriptor.RESULT_URL, getNumberOfNewWarnings(), getNumberOfFixedWarnings());
  }
  ...
  public String getSummary() {
    return "Violations: "
        + createDefaultSummary(
            ViolationsDescriptor.RESULT_URL, getNumberOfAnnotations(), getNumberOfModules());
  }
}
