...
import static hudson.plugins.violations.types.pep8.Pep8Descriptor.PEP8;
...
public class Pep8ParserTest extends JenkinsRule {
    @Rule
    ...
    public void testThatPep8LogFileCanBeParsed() throws Exception {
        violationsReport(PEP8).reportedIn("**/pep8-report.log").perform().assertThat("trunk/src/python/file.py")
                .wasReported().reportedViolation(1, "W291", "trailing whitespace")
                .reportedViolation(98, "E111", "Message #has! 12special-_ chars|?.");
    }
}
